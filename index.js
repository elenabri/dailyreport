...
async function getPromotionStats(
    ...
    // --------------------------------------------------------
    // Кампании, изменённые за последние 7 дней
    // --------------------------------------------------------
...
// ============================================================
// ЗАКАЗЫ И ПРОДАЖИ ЗА 30 ДНЕЙ
//
// Один запрос WB:
// /api/v1/supplier/orders?dateFrom=...&flag=0
//
// Внутри локально храним по каждому товару и каждому дню:
//
// orders -> количество заказов
// sales  -> количество продаж
//
// Для Dashboard используются последние 7 дней.
// orders30 -> заказы за весь загруженный период 30 дней.
// ============================================================
...
//
// Здесь храним ТОЛЬКО:
// orders -> количество заказов по каждому товару и дню
//
// Продажи здесь НЕ считаем.
// Они приходят отдельно из getDailyFinancials().
// ============================================================
...
//
// Один отчёт за выбранный период.
// Если получено 100000 строк — продолжаем через rrdId.
//
// Результат:
//
// result[nmId][date] = {
