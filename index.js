...
async function getOrders30Days(
    ...
    for (
        ...
        // ЗАКАЗ
        //
        // Каждая строка /order — отдельный заказ.
        // ====================================================
        ...
        // ПРОДАЖА
        //
        // В orders API признак продажи:
        // isCancel === false
        //
        // Если товар не был отменён,
        // считаем его продажей.
        // ====================================================
    ...
    // 5. ЗАПОЛНЯЕМ ВСЕ ДНИ
    //
    // Чтобы у каждого товара были записи за все 30 дней.
    // ========================================================
