...
// РЕКЛАМА — FULLSTATS
//
// Для каждого nmId и дня сохраняем:
//
// views         -> Показы
// clicks        -> Клики
// atbs          -> Корзины
// cpm           -> CPM
// spend         -> Затраты
// orders        -> Заказы из продвижения
// ordersAmount  -> Сумма заказов из продвижения
//
// ВАЖНО:
// orders здесь НЕ являются "Все заказы".
// "Все заказы" получаются отдельно из /supplier/orders.
// ============================================================
...
async function getPromotionStats(
    ...
    for (
        ...
        for (
            ...
            for (
                ...
                // ------------------------------------------------
                // Защита от дней вне выбранного периода
                // ------------------------------------------------
    ...
    console.log(
        'WB PROMOTION: локальная обработка завершена'
    );
...
//
// Здесь НЕТ продаж.
// Продажи приходят отдельно из Finance.
// ============================================================
